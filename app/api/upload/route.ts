  ...
  try {
    ...
    if (
      ...
      await safeInvalidateWaveBProfitReadModel({
        ...
        marketplace: "WB",
        companyScope: companyName || "ALL",
        dateFrom: adsPeriod.dateFrom?.toISOString().slice(0, 10),
        dateTo: adsPeriod.dateTo?.toISOString().slice(0, 10),
      });
    }
    ...
    if (detection.reportType === "OZON_ADS") {
      ...
      await safeInvalidateWaveBProfitReadModel({
        ...
        marketplace: "OZON",
        companyScope: companyName || "ALL",
        dateFrom: ozonAdsReportDate
          ? ozonAdsReportDate.toISOString().slice(0, 10)
          : undefined,
        dateTo: ozonAdsReportDate
          ? ozonAdsReportDate.toISOString().slice(0, 10)
          : undefined,
      });
    }
