      ...
      <div className="mx-auto max-w-[1600px] space-y-6">
        <div>
          ...
          <p className="mt-3 text-slate-500">
            Реквизиты, налоговые настройки, счета, кредиты и финансовая сводка
            по компаниям.
          </p>
        </div>
    ...
    <div className="md:col-span-2 xl:col-span-4">
      <button className="rounded-xl bg-slate-900 px-5 py-3 font-semibold text-white">
        ...
        <section className="grid gap-6 xl:grid-cols-2">
          {rows.map((row) => (
            <div key={row.company.id} className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <div className="rounded-xl border border-slate-200 p-4">
                  <div className="text-sm text-slate-500">Начальные остатки</div>
                ...
                <div className="rounded-xl border border-slate-200 p-4">
                  <div className="text-sm text-slate-500">Платёж по кредитам</div>
                ...
                <div className="rounded-xl border border-slate-200 p-4">
                  <div className="text-sm text-slate-500">Доходы / расходы</div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link href="/finance/accounts" className="rounded-xl border border-slate-300 px-4 py-2 font-semibold text-slate-700">
                  Счета
                </Link>

                <Link href="/finance/loans" className="rounded-xl border border-slate-300 px-4 py-2 font-semibold text-slate-700">
                  Кредиты
                </Link>

                <Link href="/finance/operations" className="rounded-xl bg-slate-900 px-4 py-2 font-semibold text-white">
                  Операции
                </Link>
              </div>
            </div>
