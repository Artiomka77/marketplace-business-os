...
for (const companyName of selectedCompanies) {
  ...
  analyticsByCompany.push({
    ...
    costIncomplete: loaded.abcCostIncomplete,
    abcDataMode: loaded.abcDataMode,
  });
}
...
const abcDataMode = analyticsByCompany.every(
  (item) => item.abcDataMode === "FINAL"
)
  ? "FINAL"
  : "PRELIMINARY";

  const rows = deriveAbcRawRows(analyticsByCompany, marketplace).filter(
  ...
  return (
    <main
      className="min-h-screen bg-slate-100"
      data-abc-wb-pnl-availability={wbUnavailable ? "unavailable" : "available"}
  ...
  <div className="p-8">
      <div className="mx-auto max-w-[1600px] space-y-6">
        ...
        {wbUnavailable ? (
          <section
            data-testid="abc-wb-pnl-unavailable"
          ...
          >
            <div className="font-bold">
              Финансовые данные WB за выбранный период неполны. ABC по WB недоступен.
            </div>
            <div className="mt-2 leading-6">
              Ранжирование по фейковым нулям WB не выполняется.
              {marketplace === "ALL"
                ? " Показаны только независимые данные Ozon — это не полный ABC по всем маркетплейсам."
                : marketplace === "WB"
                  ? " Финансовый ABC Wildberries не считается."
                  : ""}
            </div>
          </section>
        ) : null}
        ...
        {costIncomplete ? (
          <section
            data-testid="abc-cost-incomplete"
            className="rounded-2xl border border-amber-300 bg-amber-50 p-5 text-sm text-amber-950"
          >
            <div className="font-bold">
            ...
            <div className="mt-2 leading-6">
              SKU без подтверждённой себестоимости исключены из ранжирования ABC по прибыли.
            </div>
          </section>
        ) : null}
            ...
            <table className="w-full min-w-[1100px] text-sm">
              <thead className="bg-slate-100">
                <tr>
                  ...
                  <th className="p-3 text-right">Прибыль после налогов</th>
