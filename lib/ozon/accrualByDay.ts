...
const TYPE_CATEGORY = new Map<number, OzonFinancialCategory>([
  ...
  [46, "OZON_FBO"],
  [77, "OZON_FBO"],
  // typeId 84 = ItemPacking («Дополнительная упаковка на складе Ozon»).
  // Official /v1/finance/accrual/types + Petrov July 2026 five NON_ITEM_FEE days
  // (2026-07-06×2, 07-11, 07-14, 07-21, 07-26): structuralPath=non_item_fee,
  // dynamic source amounts −15/−30 RUB (never hardcode). Warehouse packing on
  // Ozon FBO — same family as FBO types 12/46/77. Amount policy:
  // DYNAMIC_SOURCE_AMOUNT. Unknown meaningful type IDs stay fail-closed.
  [84, "OZON_FBO"],
  [29, "OZON_DELIVERY"],
  [32, "OZON_DELIVERY"],
  [59, "OZON_DELIVERY"],
